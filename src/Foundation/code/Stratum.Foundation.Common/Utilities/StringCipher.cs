...
namespace Stratum.Foundation.Common.Utilities
{
    ...
    public static class StringCipher 
    {
        ...
        {
            string encryptedString = EncryptString(plainText, CommonConfigurations.PassPhrase);
            return encryptedString;
        }

        private static string Decrypt(string cipherText)
        {
            string decryptedString = DecryptString(cipherText, CommonConfigurations.PassPhrase);
            return decryptedString;
        }

        public static string EncryptString(string plainText, string secretKey)
        {
            secretKey = string.IsNullOrWhiteSpace(secretKey) ? CommonConfigurations.PassPhrase : secretKey;
        ...
        public static string DecryptString(string cipherText, string secretKey)
        {
            ...
            {
                secretKey = string.IsNullOrWhiteSpace(secretKey) ? CommonConfigurations.PassPhrase : secretKey;
                cipherText = cipherText.Replace(CommonConstants.Characters.Space, CommonConstants.Characters.Plus);
